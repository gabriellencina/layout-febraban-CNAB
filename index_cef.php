...
<head>
    ...
    <title>Gerador parcelas e layout CEF</title>
    ...
    <div class="container text-center">
        <div class="row center">
            <div class="col-md-3 ajustaform">
                <form action="manipula_cef.php" method="POST">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="form-label" for="data">Código da operação: </label>
                        <input type="text" class="form-control" name="codigo_de_operacao">
                    </div>
